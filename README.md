...
1) Main Screen Page
![Main Screen Page]([app_screenshots/main_page.png](https://github.com/curb4387/LangPal-Prototype/blob/main/app_screenshots/main_page.png) | width=100)
   Includes:
...
4) User Profile Page
![User Profile Page](app_screenshots/profile_page.png)
   Includes:
...
5) Missions Page
![Missions Page](app_screenshots/mission_page.png)
   Includes:
